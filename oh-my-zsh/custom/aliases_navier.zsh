...
if [[ ${(%):-%M} = *navier* ]]; then
   ...
   #alias mnt_nas1='sshfs marchdf@johnsenlab.engin.umich.edu:/volume1/labdata/marchdf ~/nas1/'
   #alias mnt_nas2='sshfs marchdf@johnsenlab2.engin.umich.edu:/data/marchdf ~/nas2/'
   ...
   alias hpc='cd /mnt/tmp1/marchdf/hpcdata'
